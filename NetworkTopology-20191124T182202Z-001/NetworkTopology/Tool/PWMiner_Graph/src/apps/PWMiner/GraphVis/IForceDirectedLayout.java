...
public class IForceDirectedLayout extends ForceDirectedLayout {
     ...
     */
    public IForceDirectedLayout(String graph){
     ...
     */
    public IForceDirectedLayout(String group, boolean enforceBounds){
     ...
     * layout is computed.
     */
    public IForceDirectedLayout(String group,
     ...
     * layout is computed.
     */
    public IForceDirectedLayout(String group, ForceSimulator fsim,
	    boolean enforceBounds, boolean runonce){
		super(group);
		m_nodeGroup = PrefuseLib.getGroupName(group, Graph.NODES);
		m_edgeGroup = PrefuseLib.getGroupName(group, Graph.EDGES);
