 ...
 *
 */
class FixedForceDirectedLayoutMagic extends Layout {
     ...
     */
    public FixedForceDirectedLayoutMagic(String graph)
    {
     ...
     */
    public FixedForceDirectedLayoutMagic(String group, boolean enforceBounds)
    {
     ...
     * layout is computed.
     */
    public FixedForceDirectedLayoutMagic(String group,
     ...
     * layout is computed.
     */
    public FixedForceDirectedLayoutMagic(String group, ForceSimulator fsim,
	    boolean enforceBounds, boolean runonce)
    {
	super(group);
	m_nodeGroup = PrefuseLib.getGroupName(group, Graph.NODES);
